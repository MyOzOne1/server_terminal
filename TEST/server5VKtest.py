...
app.config['ONE_C_PAYSLIP_URL'] = 'http://192.168.202.6/test2/hs/LK_GBS/EmployeeData/PaySlip'
app.config['ONE_C_VACATIONS_URL'] = 'http://192.168.202.6/test2/hs/LK_GBS/EmployeeData/Vacations'
app.config['ONE_C_PERSONAL_DATA_URL'] = 'http://192.168.202.6/test2/hs/LK_GBS/EmployeeData/PersonalData'
app.config['ONE_C_TIMESHEET_URL'] = 'http://192.168.202.6/test2/hs/LK_GBS/EmployeeData/Timesheet'
...
def send_telegram_code(card_code):
    ...
    try:
        ...
        if not response.ok:
            ...
            logger.error("Telegram API error: %s", error_data)
            return {
                'success': False,
